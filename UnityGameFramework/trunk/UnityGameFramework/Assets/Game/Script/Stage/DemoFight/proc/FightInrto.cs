...
[Serializable]
public class FightInrto : ProcBase
{
    // .........
    Fight fight;
    ...
    {
        if (GUILayout.Button("goto FightReady"))
        {
            fight.GotoNextProc(typeof(FightReady).ToString());
        }
    }
    ...
    public FightInrto(MonoBehaviour mono, string procName)
        : base(mono, procName)
    {
        fight = mono as Fight;
    }
